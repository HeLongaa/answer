...
type FollowRepo interface {
	...
	GetUnfollowUserIDs(ctx context.Context, objectID string) (userIDs []string, err error)
	IsFollowed(ctx context.Context, userId, objectId string) (bool, error)
	IsFollowedWithCancelState(ctx context.Context, userId, objectId string) (followed bool, exists bool, err error)
