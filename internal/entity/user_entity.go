...
type User struct {
	...
	SubscriptionLevel     string    `xorm:"not null default 'free' VARCHAR(100) subscription_level"`
	SubscriptionStartedAt time.Time `xorm:"DATETIME subscription_started_at"`
	SubscriptionExpiresAt time.Time `xorm:"DATETIME subscription_expires_at"`
}
